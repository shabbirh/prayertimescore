...
{
	public class FallBackPrayerCalculator
	{
		...
		private double _timeZone;   // time-zone - modified type to double instead of int (srh - 26-03-2023)
		...
		public FallBackPrayerCalculator()
		{
			times = new int[7];
		...
		public double[] adjustTimes(double[] times)
		{
			for (int i = 0; i < 7; i++)
			{
				times[i] += this._timeZone - this.lng / 15;
			}
