...
namespace PrayerTimes.Tests
{
    public class PrayerTests
    {
        ...
        [Fact]
        //Test get 1-day prayer times at [2, 101, 2] using JAKIM on April 12th, 2018.
        ...
        [Fact]
        //Test get today (mocked for April 12th, 2018) prayer times at [2, 101, 2] using JAKIM.
        ...
        [Fact]
        //Test get current (mocked for April 12th, 2018) prayer time at [2, 101, 2] using JAKIM.
        ...
        [Fact]
        //Test get next (mocked for April 12th, 2018) prayer time at [2, 101, 2] using JAKIM.
        ...
        [Fact]
        //Test get later (mocked for April 12th, 2018) prayer time at [2, 101, 2] using JAKIM.
        ...
        [Fact]
        //Test get after later (mocked for April 12th, 2018) prayer time at [2, 101, 2] using JAKIM.
